package com.jee.afJDBCWebApplication.controller;

import com.jee.afJDBCWebApplication.dto.Student;
import com.jee.afJDBCWebApplication.factory.StudentServiceFactory;
...
public class ControllerServlet extends HttpServlet {
    ...
    private void doProcess(HttpServletRequest request, HttpServletResponse response)
        ...
        if (requestURI.endsWith("layout")) {
            rd = request.getRequestDispatcher("/jdbcwebappfiles/layout.html");
        ...
        if (requestURI.endsWith("addform")) {
            ...
            if (status.equals("success")) {
                rd = request.getRequestDispatcher("../jdbcwebappfiles/success.html");
                rd.forward(request, response);
            } else {
                rd = request.getRequestDispatcher("../jdbcwebappfiles/failure.html");
                rd.forward(request, response);
            }
        ...
        if (requestURI.endsWith("searchform")) {
            ...
            if (student != null) {
                ...
                rd = request.getRequestDispatcher("../jdbcwebappfiles/notfound.html");
                rd.forward(request, response);
            }
        }
