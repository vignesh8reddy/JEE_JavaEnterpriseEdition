...
public class StudentDaoImpl implements IStudentDao {
    ...
    public String save(Student student) {
        ...
        String sqlInsertQuery = "INSERT INTO student002(`sname`,`sage`,`saddr`) VALUES(?,?,?)";
    ...
    public Student findById(Integer sid) {
        ...
        String sqlSelectQuery = "SELECT sid,sname,sage,saddr FROM student002 WHERE sid=?";
        PreparedStatement pstmt = null;
    ...
    public String updateById(Student student) {
        String sqlUpdateQuery = "UPDATE student002 sname=?,sage=?,saddr=? WHERE sid = ?";
        PreparedStatement pstmt = null;
        String status = null;
        try {
            connection = JDBCUtil.getConnection();
    ...
    public String deleteById(Integer sid) {
        ...
        String sqlDeleteQuery = "DELETE FROM student002 WHERE sid = ? ";
        PreparedStatement pstmt = null;
        String status = null;
        try {
